...
pnpm --filter=!@cn-ui/reactive  --filter=!@cn-ui/use --filter=!@cn-ui/transition --filter=!@cn-ui/animate --filter=!@cn-ui/headless --filter=!@cn-ui/core --filter=!@cn-ui/doc --filter=!demo build
