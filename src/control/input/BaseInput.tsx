import { OriginComponent, atomization, classNames, computed, extendsEvent } from '@cn-ui/reactive'
...
interface BaseInputProps extends CountProps {
    id?: string // The ID for input
    disabled?: boolean // Whether the input is disabled
    prefixIcon?: JSXElement // The prefix icon for the Input
    suffixIcon?: JSXElement // The suffix icon for the Input
...
export const BaseInput = OriginComponent<BaseInputProps, HTMLInputElement, string>((props) => {
    ...
    const Prefix = computed(() => {
        return <span class="mr-1">{props.prefixIcon}</span>
    })
